...
export function activate(context: vscode.ExtensionContext) {
	...
	let pasteUpload = vscode.commands.registerCommand('extension.tencentCOSUpload.paste', () => {
	...
	let selectUpload = vscode.commands.registerCommand('extension.tencentCOSUpload.select', () => {
		// The code you place here will be executed every time your command is executed
